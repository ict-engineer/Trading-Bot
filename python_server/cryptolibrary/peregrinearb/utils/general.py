...
def getResult_Single(graph, path, round_to=None, depth=False, starting_amount=100):
    if not path:
        return
...
def getResult_Multi(graph: nx.Graph, path, print_output=True, round_to=None, shorten=False):
    """

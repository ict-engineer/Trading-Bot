        ...
        return array_replace_recursive (parent::describe (), array (
            ...
            'exceptions' => array (
                'exact' => array (
                    ...
                    'Order could not be cancelled.' => '\\ccxt\\OrderNotFound',
                    'No such order found.' => '\\ccxt\\OrderNotFound', // ?
                    'Order price must be positive.' => '\\ccxt\\InvalidOrder',
                    ...
                    'No summary found.' => '\\ccxt\\ExchangeError',
                    'Cannot evaluate your available balance, please try again' => '\\ccxt\\ExchangeNotAvailable',
                ),
                'broad' => array (
                    'This API key does not have permission' => '\\ccxt\\PermissionDenied',
                    'Invalid order => not enough exchange balance for ' => '\\ccxt\\InsufficientFunds',
                    'Invalid order => minimum size for ' => '\\ccxt\\InvalidOrder',
                    'Invalid order' => '\\ccxt\\InvalidOrder', // ?
                    'The available balance is only' => '\\ccxt\\InsufficientFunds',
                ),
            ),
